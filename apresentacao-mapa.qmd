...
[*É necessário observar que nos próximos gráficos é possível interagir ao escolher a ou as regiões de destaque, assim como para cada ano, ao passar o indicador por cima, é possível ver o total do ano e a variação ano a ano.*]{style="text-indent: 1.5cm; display: block; text-align: justify"}
