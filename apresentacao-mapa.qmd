...
df|>
  ...
  hc_title(
    ...
    hc_subtitle(
      text = "Totais por Sub-região Europeia e Variação Anual (%)",
      align = "center",
      style = list(
        fontsize = "14px",
        fontFamily = "Arial"
...
[As exportações dos países do Leste Europeu sofreram uma transformação radical após 1989. Durante a década de 1980, sob o regime comunista, o desempenho exportador foi decepcionante, com participação declinante nas importações da OCDE. Após as reformas pós-1989, ocorreu uma rápida reorientação comercial dos mercados do CMEA para os mercados ocidentais, com a União Europeia aumentando sua participação de 68% para 77% nas exportações regionais. O crescimento explosivo de 1200% em 1989 foi impulsionado pelo colapso do CMEA, queda na demanda doméstica e reformas que tornaram as empresas mais responsivas ao mercado. Contudo, a sustentabilidade permaneceu incerta devido à base industrial obsoleta, privatização lenta e falta de infraestrutura adequada, evidenciando a dificuldade do bloco oriental em manter crescimento econômico saudável a longo prazo.]{style="text-indent: 1.5cm; display: block; text-align: justify"}
